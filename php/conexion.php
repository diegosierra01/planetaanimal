<?php
$servidor = "sql6.freesqldatabase.com"; //el servidor que utilizaremos, en este caso será el localhost
$usuario = "sql6117798"; //El usuario que acabamos de crear en la base de datos
$contrasenha = "hCgmaIwE3l"; //La contraseña del usuario que utilizaremos
$BD = "sql6117798"; //El nombre de la base de datos
